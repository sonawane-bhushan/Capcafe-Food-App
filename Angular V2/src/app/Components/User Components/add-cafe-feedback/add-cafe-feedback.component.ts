...
export class AddCafeFeedbackComponent implements OnInit {
  ...
  addCafeFeedback() {
    this.service.saveCafeReview(this.userId, this.cafe.cafeName, this.type, this.cafeReview).subscribe(data => {
      this.review = data;
      console.log(this.review);
      console.log(this.cafeReview);
    });
    this.service.saveCafeRating(this.userId, this.cafe.cafeName, this.type, this.cafeRating).subscribe(data => {
      this.review = data;
      console.log(this.review);
