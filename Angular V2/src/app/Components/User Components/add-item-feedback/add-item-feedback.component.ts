...
export class AddItemFeedbackComponent implements OnInit {
  ...
  addItemFeedback() {
    this.service.saveItemRating(this.userId, this.item.itemName, this.type, this.cafeRating).subscribe(data => {
      this.feedback = data;
      console.log(this.feedback);
    });
    this.service.saveItemReview(this.userId, this.item.itemName, this.type, this.cafeReview).subscribe(data => {
      this.feedback = data;
      console.log(this.feedback);
    });
