...
import { HelpdeskAdminService } from '../helpdesk-service/helpdesk-admin.service';
...
export class AdminChatComponent implements OnInit {
  ...
  getTicketDetails(){
    this.service.getTicketByNumber(this.ticketNumber).subscribe(data =>{ this.ticket = data
    this.sortMessagesById();
    });
  ...
  giveResponseByTicketNumber(){
    this.service.addResponseByTicketNumber(this.ticketNumber,this.message).subscribe(data => {this.ticket = data;
    this.getTicketDetails();
