...
export class UserChatComponent implements OnInit {
  ...
  getTicketByOrderId(){
    this.service.getTicketByOrderId(this.orderId).subscribe(data =>{ this.ticket = data;
      this.sortMessagesById()
    });
  }

  giveRequestByOrderId(){
    this.service.addResponseByOrderId(this.orderId, this.message).subscribe(data => { this.ticket = data;
    this.getTicketByOrderId();
    this.message = "";
  });   
  }
  ...
  markAsResolved(){
    this.service.markAsResolved(this.ticket.ticketNumber).subscribe(data =>{ this.resolved = data; 
      this.getTicketByOrderId();
    });
  }
